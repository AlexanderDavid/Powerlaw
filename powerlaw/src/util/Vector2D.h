...
/*!
 *  @file       Vector2D.h
 *  @brief      Contains the Vector2D class; a two-dimensional vector class and
...
/*!
        ...
        @param v1 A vector
    @param v2 A vector
    @return Returns the cross product between the two vectors i.e determinant of
   the 2x2 matrix formed by using v1 as the first row and v2 as the second row.
 */
inline float det(const Vector2D &v1, const Vector2D &v2) {
