 ...
 * To make sure that all functions in the library are not conflicting with any
 * other function the library uses it's own namespace. One always needs to use
 * this namespace to access the functions inside this library.
 */
...
public:
  ...
  */
  ...
  /*!
   * @brief
   * This function determines whether the simulation has to stop i.e. when all
   * characters have reached their goals or the simulation steps have exceeded
   * the maximum allowed number.
   * @return The function returns true when the simulation has to stop. False
   * otherwise. */
  bool endSimulation();
...
*/
  ...
  ///  Returns the global time of the simulation. Initially this time is set
  ///  to zero.
